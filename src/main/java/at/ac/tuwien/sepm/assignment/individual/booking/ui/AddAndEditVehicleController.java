...
public class AddAndEditVehicleController implements Initializable{
    ...
    void addButtonCliked(ActionEvent event) {
        try {
            logger.info("add button clicked for vehicle");
            check();
            vehicle = new Vehicle();
    ...
    public void setTextFieldEmpty(){
        tf_model.setText("");
        tf_constructionYear.setText("");
        tf_description.setText("");
        tf_seating.setText("");
        rb_motorized.setSelected(true);
        rb_brawn.setSelected(false);
        tf_plateNumber.setText("");
        tf_power.setText("");
        tf_basePrice.setText("");
        try {
            iv_image.setImage(new Image(new FileInputStream("src\\main\\resources\\Images\\noImageCar.jpeg")));
    ...
    void selectImageButtonCliked(ActionEvent event) {
        ...
        logger.info("select image button cliked");
    ...
    void editButtonCliked(ActionEvent event) {
        try {
            logger.info("edit button clicked for vehicle.");
            check();
            vehicle.setModel(tf_model.getText());
            vehicle.setConstructionYear(Integer.parseInt(tf_constructionYear.getText()));
            vehicle.setDescription(tf_description.getText());
    ...
    void deleteButtonCliked(ActionEvent event) {
        try {
            logger.info("delete button clicked for vehicle.");
